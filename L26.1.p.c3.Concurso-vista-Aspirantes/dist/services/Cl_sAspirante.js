class Cl_sAspirante {
    static apiUrl = "https://6a108664d2a985707036e6c3.mockapi.io/Proyectos/ConcursoV2";
    static async guardarRegistro(nuevoAspirante) {
        try {
    ...
    static async existeAspirante(cedula) {
        try {
